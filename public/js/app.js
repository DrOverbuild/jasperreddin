(function () {
    ...
    app.controller('musicController', function ($scope) {
        ...
        $scope.music = [{
            ...
            spotifyId: "1eUDipzNvDye3p1dXBVbHC"
        }, {
            title: "Meaningless",
            ...
            spotifyId: "4KPE7dYGWc5hZFNcLf7wr5"
        }, {
            ...
            spotifyId: "11n06FUiGJHy2NzfixoDAF"
        }, {
            ...
            spotifyId: "4cAbEdA9RtbBicxtaDDoz5"
        }, {
            title: "Comic Punch",
            ...
            spotifyId: "5HxcdOSOe7eusQ5nvoy6wL"
        }];
        ...
        $scope.ytClicked = function (id) {
            ytmodal.html(`<iframe id="ytplayer" class="player" type="text/html"` +
        ...
        $scope.spotifyClicked = function (id) {
            ytmodal.html(
                `<iframe id="spotifyplayer" class="player" src="https://open.spotify.com/embed/track/${id}" ` +
